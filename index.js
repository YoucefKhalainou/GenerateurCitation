...
let citationContenue = document.querySelector('#citation');
let nomAuteur = document.querySelector('#auteur');
let nouveauCitation = document.querySelector('#nouveau');

let dernier = 0;
let nombreAleatoire = 0;


nouveauCitation.addEventListener('click', () => {
    do {
        nombreAleatoire = genererNombreEntier(citations.length);
    } while (nombreAleatoire == dernier);
    citationContenue.textContent = citations[nombreAleatoire][0];
